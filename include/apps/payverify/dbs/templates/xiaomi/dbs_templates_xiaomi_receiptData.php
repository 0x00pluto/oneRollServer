...
namespace apps\payverify\dbs\templates\xiaomi;
 ...
 * sourceFile:
 * Class dbs_templates_xiaomi_receiptData
 * @package apps\payverify\dbs\templates\xiaomi
 */
abstract class dbs_templates_xiaomi_receiptData extends super
{
    /**
     * 表名
     *
     * @var string
     */
    const DBKey_tablename = "xiaomiReceiptDatas";
    /**
     * 数据类型
     *
     * @var
    ...
    {
        $this->set_defaultkeyandvalue ( self::DBKey_dataTemplateType, "xiaomi.receiptData" );
    }
    /**
     * 唯一id
     *
     ...
     * @var
     */
    const DBKey_receiptString = "receiptString";

	/**
	 * 获取 票据
	 * @return string
	 */
	public function get_receiptString()
	{
		return $this->getdata ( self::DBKey_receiptString );
	}
	 ...
	 * @return $this
	 */
	public function set_receiptString($value)
	{
		$this->setdata ( self::DBKey_receiptString, strval($value) );
		return $this;
	}
     ...
     * @return $this
     */
    public function reset_receiptString()
    {
        return $this->reset_defaultValue(self::DBKey_receiptString);
    }

    /**
     * 设置 票据 默认值
     */
    protected function _set_defaultvalue_receiptString()
    {
        $this->set_defaultkeyandvalue ( self::DBKey_receiptString, "" );
    }
    ...
    protected function initializeDefaultValues()
    {
        ...
        //设置 票据 默认值
        $this->_set_defaultvalue_receiptString();
