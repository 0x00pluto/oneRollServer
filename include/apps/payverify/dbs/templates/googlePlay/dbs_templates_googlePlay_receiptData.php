...
namespace apps\payverify\dbs\templates\googlePlay;
 ...
 * sourceFile:
 * Class dbs_templates_googlePlay_receiptData
 * @package apps\payverify\dbs\templates\googlePlay
 */
abstract class dbs_templates_googlePlay_receiptData extends super
{
    /**
     * 表名
     *
     * @var string
     */
    const DBKey_tablename = "googleplayreceiptdata";
    /**
     * 数据类型
     *
     * @var
    ...
    {
        $this->set_defaultkeyandvalue ( self::DBKey_dataTemplateType, "googlePlay.receiptData" );
    }
    /**
     * 唯一id
     *
     ...
     * @var
     */
    const DBKey_purchasedata = "purchasedata";

	/**
	 * 获取 签名数据
	 * @return string
	 */
	public function get_purchasedata()
	{
		return $this->getdata ( self::DBKey_purchasedata );
	}
	 ...
	 * @return $this
	 */
	public function set_purchasedata($value)
	{
		$this->setdata ( self::DBKey_purchasedata, strval($value) );
		return $this;
	}
     ...
     * @return $this
     */
    public function reset_purchasedata()
    {
        return $this->reset_defaultValue(self::DBKey_purchasedata);
    }

    /**
     * 设置 签名数据 默认值
     */
    protected function _set_defaultvalue_purchasedata()
    {
        $this->set_defaultkeyandvalue ( self::DBKey_purchasedata, "" );
    }
    ...
    protected function initializeDefaultValues()
    {
        ...
        //设置 签名数据 默认值
        $this->_set_defaultvalue_purchasedata();
