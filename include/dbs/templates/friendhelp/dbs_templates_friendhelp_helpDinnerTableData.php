 ...
 * sourceFile:
 * Class dbs_templates_friendhelp_helpDinnerTableData
 * @package dbs\templates\friendhelp
 */
class dbs_templates_friendhelp_helpDinnerTableData extends super
{
    /**
     * 数据类型
     *
    ...
    {
        $this->set_defaultkeyandvalue ( self::DBKey_dataTemplateType, "friendhelp.helpDinnerTableData" );
    }
    /**
     * 主题餐厅ID
     *
