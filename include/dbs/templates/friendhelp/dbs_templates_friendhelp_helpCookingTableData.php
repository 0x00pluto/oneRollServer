 ...
 * sourceFile:
 * Class dbs_templates_friendhelp_helpCookingTableData
 * @package dbs\templates\friendhelp
 */
class dbs_templates_friendhelp_helpCookingTableData extends super
{
    /**
     * 数据类型
     *
    ...
    {
        $this->set_defaultkeyandvalue ( self::DBKey_dataTemplateType, "friendhelp.helpCookingTableData" );
    }
    /**
     * 主题餐厅ID
     *
     ...
     * @var
     */
    const DBKey_buildingId = "buildingId";
	...
	{
		return $this->getdata ( self::DBKey_buildingId );
	}
	 ...
	 * @return $this
	 */
	public function set_buildingId($value)
	{
		$this->setdata ( self::DBKey_buildingId, strval($value) );
		return $this;
	}
     ...
     * @return $this
     */
    public function reset_buildingId()
    {
        return $this->reset_defaultValue(self::DBKey_buildingId);
    }

    /**
     * 设置 烹饪台ID 默认值
     */
    protected function _set_defaultvalue_buildingId()
    {
        $this->set_defaultkeyandvalue ( self::DBKey_buildingId, "" );
    }
    /**
    ...
    protected function initializeDefaultValues()
    {
        ...
        //设置 烹饪台ID 默认值
        $this->_set_defaultvalue_buildingId();
        //设置 帮忙用户列表:用户ID=>helperData 默认值
