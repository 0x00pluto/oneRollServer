 ...
 * sourceFile:
 * Class dbs_templates_examples_roleglobalDBFriend
 * @package dbs\templates\examples
 */
abstract class dbs_templates_examples_roleglobalDBFriend extends super
{
    /**
     * 表名
     *
    ...
    {
        $this->set_defaultkeyandvalue ( self::DBKey_dataTemplateType, "examples.roleglobalDBFriend" );
    }
    /**
     * 用户名
     *
